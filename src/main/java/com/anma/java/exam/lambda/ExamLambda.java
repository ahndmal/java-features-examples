...
//        Consumer<String> con1 = final String x -> System.out.println(x);      -> parenthesis
//        Consumer<String> con2 = final var x -> System.out.println(x);         -> parenthesis
//        Consumer<String> con3 = final x -> System.out.println(x);             -> parenthesis
...
//        UnaryOperator<Integer> una1 = (final String x) -> x;

        Function<Integer, Integer> function4 = (x) -> x * x;
